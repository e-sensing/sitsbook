...
## Python
```{python}
#| label: py-merge-print-timeline-s2
#| cache: true
# Timeline of the Sentinel-2 cube
sits_timeline(hls_cube_s2)
```
...
## Python
```{python}
#| label: py-merge-print-timeline-l8
#| cache: true
# Timeline of the Landsat-8 cube
sits_timeline(hls_cube_l8)
```
...
## Python
```{python}
#| label: py-merge-print-timeline-merged
#| cache: true
# Timeline of the merged cube
sits_timeline(hls_cube_merged)
```
...
#| eval: false
#| echo: false
saveRDS(merged_cube_base$base_info[[1]], file.path(tempdir_r, "merged_cube_base_info.rds"))
```

```{r}
#| eval: false
#| echo: false
merged_cube_base_info <- readRDS(file.path(tempdir_r, "merged_cube_base_info.rds"))
merged_cube_base_info
```

```{python}
#| eval: false
#| echo: false
merged_cube_base_info = read_rds(file = tempdir_py / "merged_cube_base_info.rds")
merged_cube_base_info
```
...
#| eval: false
#| echo: false
saveRDS(merged_cube$file_info[[1]], file.path(tempdir_r, "merged_cube_file_info.rds"))
```

```{r}
#| eval: false
#| echo: false
merged_cube_file_info <- readRDS(file.path(tempdir_r, "merged_cube_file_info.rds"))
...
#| eval: false
#| echo: false
merged_cube_file_info = read_rds(file = tempdir_py / "merged_cube_file_info.rds")
merged_cube_file_info
```
