...
1.  Amazon Fund, established by the Brazilian government with financial contribution from Norway, through the contract between the Brazilian Development Bank (BNDES) and the Foundation for Science, Technology and Space Applications (FUNCATE), for the establishment of the Brazil Data Cube,  process 17.2.0536.1. 
...
The authors would like to acknowledge the contributions of Marius Appel, Tim Appelhans, Henrik Bengtsson, Robert Hijmans, Edzer Pebesma, and Ron Wehrens, respectively chief developers of the R packages `gdalcubes`,  `leafem`, `data.table`, `terra`, `sf`/`stars`, and "kohonen". We are indebted to the RStudio team, including Hadley Wickham for the `tidyverse` and Daniel Falbel for `torch`.
...
- Ron Wehrens and Kruisselbrink, Johannes. "Flexible Self-Organising Maps in kohonen 3.0". Journal of Statistical Software, 87, 7 (2018).
