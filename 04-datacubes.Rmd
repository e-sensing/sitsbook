...
```{r aws, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-2 image in an area of the Northeastern coast of Brazil (source: authors)."}
...
```{r mpc1, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-2 image in an area of the state of Rondonia, Brazil (source: authors)."}
...
```{r mpc2, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Landsat-8 image in an area in Northeast Brazil (source: authors)."}
...
```{r mpc3, tidy="styler", cache = TRUE, out.width="100%", fig.align="center", fig.cap= "Sentinel-1 image in an area in Mato Grosso, Brazil (source: authors)."}
...
```{r mpcrtcol, tidy="styler", cache = TRUE, out.width="100%", fig.align="center", fig.cap= "Sentinel-1-RTC image of an area in Colombia (source: authors)."}
...
```{r mpc4, tidy="styler", out.width="100%", fig.align="center", fig.cap= "Copernicus 30-meter DEM of an area in Brazil (source: authors)."}
...
```{r cbers, echo = FALSE, out.width="100%", fig.align="center", fig.cap="CBERS-4 WFI image in a Cerrado area in Brazil (source: authors)."}
...
```{r lena, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-2 image of the Lena river delta in summertime (source: authors)."}
...
```{r cdsertc, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-1-RTC image of the Rift Valley in Ethiopia (source: authors)."}
...
```{r dea1, echo = FALSE, out.width="100%", fig.align="center", fig.cap="Sentinel-2 image in an area over Madagascar (source: authors)."}
...
```{r seren, echo = FALSE, out.width="100%", fig.align="center", fig.cap="Landsat-9 image in an area over the Serengeti in Tanzania (source: authors)."}
...
```{r lakekivu, echo = FALSE, out.width="100%", fig.align="center", fig.cap="ALOS-PALSAC mosaic in the Congo forest area (source: authors)."}
...
```{r goldcoast, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of Sentinel-2 image obtained from the DEAUSTRALIA collection for date 2023-10-14 showing MGRS tile 56KKV (source: authors)."}
...
```{r hlssen, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of Sentinel-2 image obtained from the NASA HLS collection for date 2020-06-15 showing the island of Ilhabela in the Brazilian coast  (source: authors)."}
...
```{r hlsmerge, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of Sentinel-2 image obtained from merging NASA HLS collection and Sentinel-2 collection for date 2020-06-15 showing the island of Ilhabela in the Brazilian coast (source: authors)."}
...
```
```{r worldcover, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of World Cover 2021 map covering MGRS tile 22LBL (source: authors)."}
...
```{r planet, tidy="styler", out.width="100%", fig.align="center", fig.cap="Planet image over an area in Colombia (source: authors)."}
...
```{r mapdata, tidy="styler", out.width="100%", fig.align="center", fig.cap="Classified data cube for the year 2020/2021 in Rondonia, Brazil (source: authors)."}
...
```{r senroirreg, cache = TRUE, tidy="styler", out.width="100%", fig.align="center", fig.cap="Sentinel-2 tile 20LLP for date 2018-07-03 (source: authors)."}
...
```{r senroreg, cache = TRUE, tidy="styler", message = FALSE, results='hide', out.width="100%", fig.align="center", fig.cap="Regularized image for tile Sentinel-2 tile 20LLP (source: authors)."}
...
```{r sargrdorig, out.width="100%", fig.align="center", fig.cap="Original Sentinel-1 image covering tile 22LBL (source: authors)."}
...
```{r sarrtcreg, out.width="100%", fig.align="center", fig.cap="Regular Sentinel-1 image covering tile 22LBL (source: authors)."}
...
```{r senlbl, out.width="100%", fig.align="center", fig.cap="Sentinel-2 image covering tile 22LBL (source: authors)."}
...
```{r demchile, echo = TRUE, eval = TRUE, out.width = "100%", fig.align="center",  fig.cap="Copernicus DEM-30 covering tile 19HBA (source: authors)."}
