...
```{r, echo = TRUE, eval = TRUE, out_width = "100%", fig.cap="Copernicus DEM-30 covering tile 19HBA (Source: Authors)."}
...
plot(dem_cube_19HBA_reg, band = "ELEVATION", style = "cont", palette = "Spectral", rev = TRUE)
```
