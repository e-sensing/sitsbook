...
#| fig-dpi: 300
#| fig-cap: |
#|     Global plot of Landsat collection avaible at OGH.
#| out-width: 100%
# define a region of interest
...
To access Terrascope, users need to be registered at the [cloud provider](https://terrascope.be/en). After registration, please include the environmental variables `TERRASCOPE_USER` and `TERRASCOPE_PASSWORD` in you `.Rprofile` configuration. 
