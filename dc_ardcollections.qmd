...
bbox_22LBL <- sits_tiles_to_roi("22LBL")
...
# Plot the cube
plot(aef_cube, red = "A03", green = "A14", blue = "A15")
```
:::

```{r}
#| echo: false
#| label: fig-alphaearth-datacubes
#| out-width: 100%
#| fig-cap: |
#|   AlphaEarth Foundations satellite embedding for a region in the Brazilian Federal District.
#| fig-align: center
knitr::include_graphics("./images/google_alphaearth.png")
```
