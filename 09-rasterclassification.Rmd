...
```{r rcndvi, tidy = "styler", out.width = "90%", fig.align="center", fig.cap="Color composite image of the cube for date 2023-07-16 (source: authors)."}
...
```{r rcrfmodel, tidy = "styler", out.width = "90%", fig.align="center", fig.cap="Most relevant variables of the Random Forest model (source: authors)."}
plot(rfor_model)
```
