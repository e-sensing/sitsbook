...
```{r rcndvi, tidy = "styler", out.width = "90%", fig.align="center", fig.cap="Color composite image of the cube for date 2023-07-16 (&copy; EU Copernicus Sentinel Programme; source: Microsoft)."}
...
```{r, echo = FALSE}
rfor_model <- readRDS("./etc/rfor_model_chp09.rds")
```

```{r rcrfmodel, out.width = "90%", fig.align="center", fig.cap="Most relevant variables of the Random Forest model (source: authors)."}
plot(rfor_model)
```
...
```{r rcprobs, tidy = "styler", out.width = "90%", fig.align="center", fig.cap="Probabilities for class Forest  (source: authors)."}
...
```{r rcbayes, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Smoothened probabilities for class Forest  (source: authors)."}
...
```{r rcmap, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Final map of deforestation obtained by random forest model(source: authors)."}
...
```{r probstcnn, tidy="styler", eval = FALSE}
...
rondonia_20LMR_class_tcnn <- sits_cube(
    source = "MPC",
    collection = "SENTINEL-2-L2A",
    data_dir = "./tempdir/chp9",
    labels = labels,
    bands = "class",
    version = "tcnn-raster"
)
...
```{r rctcnnmap, tidy="styler", out.width = "90%", fig.align="center", fig.cap="Final map of deforestation obtained using TempCNN model (source: authors)."}
...
```{r rcreclasorig, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Original classification map (source: authors)."}
...
```{r rcprodes, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Deforestation map produced by sits (source: authors)."}
...
```{r prodesview, echo = FALSE, out.width="90%", fig.align="center", fig.cap="Deforestation map produced by PRODES (source: authors)."}
...
```{r prodesreclass, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Deforestation map by sits masked by PRODES map (source: authors)."}
# Reclassify cube
