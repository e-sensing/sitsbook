...
```{r mlp, tidy="styler", out.width = "80%", warning = FALSE, message = FALSE, fig.align="center", fig.cap="Evolution of training accuracy of MLP model (Source: Authors)."}
...
```{r tcnnex, tidy="styler", cache = TRUE, out.width = "80%", warning = FALSE, message = FALSE, fig.align="center", fig.cap="Training evolution of TempCNN model (Source: Authors)."}
library(torchopt)
# Train using tempCNN
...
```{r tae, tidy="styler", out.width = "100%", cache = TRUE, warning = FALSE, message = FALSE, fig.align="center", fig.cap="Training evolution of Temporal Self-Attention model (Source: Authors)."}
...
```{r ltae, tidy="styler", out.width = "80%", warning = FALSE, message = FALSE, fig.align="center", fig.cap="Training evolution of Lightweight Temporal Self-Attention model (Source: Authors)."}
# Train a machine learning model using TAE
