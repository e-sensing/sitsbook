...
```{r mlrformodel, tidy="styler",out.width = "90%", fig.align="center", fig.cap="Most important variables in random forest model (source: authors)."}
...
```{r mlrforplot, tidy="styler",out.width = "90%", fig.align="center", fig.cap="Classification of time series using random forest (source: authors)."}
...
```{r mlsvmplot, tidy="styler", out.width = "90%", fig.align="center", fig.cap="Classification of time series using SVM (source: authors)."}
# Train an SVM model
...
```{r mlxgbplot, tidy="styler", out.width = "90%", fig.align="center", fig.cap="Classification of time series using XGBoost (source: authors)."}
# Train using  XGBoost
...
```{r mlmlpplot, tidy="styler", out.width = "80%", warning = FALSE, message = FALSE, fig.align="center", fig.cap="Evolution of training accuracy of MLP model (source: authors)."}
...
```{r mltcnnmodel, tidy="styler", cache = TRUE, out.width = "80%", warning = FALSE, message = FALSE, fig.align="center", fig.cap="Training evolution of TempCNN model (source: authors)."}
library(torchopt)
# Train using tempCNN
...
```{r mltaemodel, tidy="styler", out.width = "100%", cache = TRUE, warning = FALSE, message = FALSE, fig.align="center", fig.cap="Training evolution of Temporal Self-Attention model (source: authors)."}
...
```{r mltaeplot, tidy="styler", out.width = "100%", fig.align="center", fig.cap="Classification of time series using TAE (source: authors)."}
...
```{r mlltaemodel, tidy="styler", out.width = "80%", warning = FALSE, message = FALSE, fig.align="center", fig.cap="Training evolution of Lightweight Temporal Self-Attention model (source: authors)."}
# Train a machine learning model using TAE
...
```{r mlltaeplot, tidy="styler", out.width = "100%", fig.align="center", fig.cap="Classification of time series using LightTAE (source: authors)."}
# Classify using DL model and plot the result
point_mt_mod13q1 |>  
