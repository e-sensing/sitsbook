...
```{r, out.width = "100%", fig.cap="Color composite image for 2013-09-14"}
...
```{r, out.width = "100%", fig.cap = "Smoothed probability maps"}
...
```{r, fig.cap = "Labeled classification map", fig.align="center", out.width = "100%"}
