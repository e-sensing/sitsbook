...
In this chapter, we learned how to operate on data cubes, including how to compute spectral indexes and do reducing operations. The next chapter will discuss mixture models operations in `sits`.
