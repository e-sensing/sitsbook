---
title: "Algebraic operations on data cubes"
format: html
---

<a href="https://www.kaggle.com/code/esensing/computing-ndvi-and-other-spectral-indices" target="_blank">
...
The `sits_apply()` function computes new indexes from a desired mathematical operation as a function of the bands available on the cube using any valid R expression. It applies the operation for all tiles and all temporal intervals. There are two types of operations in `sits_apply()`:
...
#| fig-align: "center"
#| fig-cap: | 
#|   NBR ratio using Sentinel-2 B12 and B8A.
...
In this chapter, we learned how to operate on data cubes, including how to compute spectral indexes. The next chapter will discuss mixture model operations in `sits`.
