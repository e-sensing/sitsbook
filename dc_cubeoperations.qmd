---
title: "Operations on EO data cubes"
format: html
---  
...
## R
```{r}
#| label: fig-dcops-redmax
#| out.width: "100%"
#| fig.align: "center"
#| fig.cap: | 
#|    Maximum NDVI for Sentinel-2 cube.
...
## Python
```{python}
#| label: fig-dcops-redmax-py
#| out.width: "100%"
#| fig.align: "center"
#| fig.cap: | 
#|    Maximum NDVI for Sentinel-2 cube.
tempdir_py_reduce = tempdir_py / "reduce"
tempdir_py_reduce.mkdir(parents = True, exist_ok = True)
# Reduce cube
max_ndvi_cube = sits_reduce(reg_cube,
    NDVIMAX = "t_max(NDVI)",
    output_dir = tempdir_py_reduce
)
plot(max_ndvi_cube, band = "NDVIMAX", palette = "Greens")
```
:::
