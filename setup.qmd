...
For users who prefer to use [conda](https://docs.conda.io/projects/conda/en/latest/index.html), the `sits` package is available on [conda-forge](https://anaconda.org/conda-forge/r-sits) channel.
...
The [conda](https://docs.conda.io/projects/conda/en/latest/index.html) version of `sits` is currently available only for macOS and Linux (x64).
:::
