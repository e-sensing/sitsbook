...
```{r, tidy="styler", eval = TRUE, echo = TRUE, out.width="100%", fig.align="center", fig.cap="CVI index using bands B03, B05, and B8A (source: authors)."}
# Calculate the NBR index
reg_cube <- sits_apply(reg_cube,
    CVI = (B8A / B03) * (B05 / B03 ),
    normalized = FALSE, 
...
```{r, tidy="styler", eval = TRUE, echo = TRUE, out.width="100%", fig.align="center", fig.cap="maximum NDVI for Sentinel-2 cube (source: authors)."}
# Calculate the NBR index
