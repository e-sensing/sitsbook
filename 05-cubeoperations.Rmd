...
```{r ndviop, tidy="styler", out.width="100%", fig.align="center", fig.cap="NDVI using bands B08 and B04 of Sentinel-2 (source: authors)."}
...
```{r ndreop, tidy="styler", out.width="100%", fig.align="center", fig.cap="NDRE1 using bands B06 and B05 of Sentinel-2 (source: authors)."}
# Plot NDRE1 index
...
```{r, tidy="styler", out.width="100%", fig.align="center", fig.cap="NBR ratio using Sentinel-2 B11 and B8A (source: authors)."}
...
```{r cviop, tidy="styler", eval = TRUE, echo = TRUE, out.width="100%", fig.align="center", fig.cap="CVI index using bands B03, B05, and B8A (source: authors)."}
# Calculate the NBR index
reg_cube <- sits_apply(reg_cube,
    CVI = (B8A / B03) * (B05 / B03 ),
    normalized = FALSE, 
...
```{r redmax, tidy="styler", eval = TRUE, echo = TRUE, out.width="100%", fig.align="center", fig.cap="maximum NDVI for Sentinel-2 cube (source: authors)."}
# Calculate the NBR index
...
```{r mixfor, tidy="styler", out.width="100%", fig.align="center", fig.cap="Percentage of forest per pixel estimated by mixture model (source: authors)."}
