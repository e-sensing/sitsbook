...
```{r, tidy = "styler", echo = FALSE, eval = TRUE,  message = FALSE, warning = FALSE, cache = TRUE}
...
```{r, tidy = "styler", out.width = "100%", fig.cap = "SOM map for the Cerrado samples (Source: Authors)."}
# Plot the SOM map
plot(som_cluster)
```
...
```{r, tidy = "styler", cache = TRUE, message = FALSE, warning = FALSE}
...
```{r, tidy = "styler", cache = TRUE, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE}
# Clustering time series using SOM
