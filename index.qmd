...
From version 1.5.3 onwards, users can run `sits` in Python. Follow the instructions on the "Setup" chapter on how to set you Python environment to interface with R. Then follow the book examples provided of using `sits` in Python. The book provides code both in R and in Python. Therefore, after correctly setting up their working environment, Python experts can run `sits` functions in their favorite tools, such as Jupyter notebooks. 
