...
knitr::include_graphics("./images/mlresnetmodel.png")
```
...
#| fig.cap: |
#|   Classification of time series using TempCNN
knitr::include_graphics("./images/mlresnetplot.png")
```
