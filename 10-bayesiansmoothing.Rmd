...
```{r bayesexnosmooth, echo=FALSE, out.width="80%", fig.align='center', fig.cap="Detail of labelled map produced by pixel-based random forest without smoothing (source: authors)"}
...
```{r bayesexsmooth, echo=FALSE, out.width="70%", fig.align='center', fig.cap="Detail of labelled map produced by pixel-based random forest after smoothing (source: uthors)"}
...
```{r bayesprobmapfor, warning = FALSE, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Probability map produced for classes Forest and Clear_Cut_Bare_Soil (source: authors)."}
...
```{r bayesprobmapveg, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Probability map produced for classes Forest and Clear_Cut_Bare_Soil (source: authors)."}
...
```{r bayesmapnosmooth, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Classified map without smoothing (source: authors)."}
...
```{r bayesvarfor, tidy = "styler", echo=TRUE, eval=TRUE, out.width = "100%", fig.align="center", fig.cap="Variance map for classes Forest and Clear_Cut_Bare_Soil (source: authors)."}
# calculate variance
...
```{r bayesvarveg, tidy = "styler", echo=TRUE, eval=TRUE, out.width = "100%", fig.align="center", fig.cap="Variance map for clases Clear_Cut_Vegetation and Clear_Cut_Burned_Area (source: authors)."}
...
```{r bayessmoothfor, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Probability maps after bayesian smoothing (source: authors)."}
...
```{r bayessmoothmap, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Final classification map after Bayesian smoothing with 7 x 7 window, using high smoothness values (source: authors)."}
# Generate the thematic map
