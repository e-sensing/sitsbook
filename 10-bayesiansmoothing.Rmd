...
```{r bayesprobmapfor, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Probability map produced for classes Forest and Clear_Cut_Bare_Soil (source: authors)."}
