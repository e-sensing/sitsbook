...
```{r echo=FALSE, out.width="80%", fig.align='center', fig.cap="Detail of labelled map produced by pixel-based random forest without smoothing (source: authors)"}
...
```{r mapsmooth, echo=FALSE, out.width="70%", fig.align='center', fig.cap="Detail of labelled map produced by pixel-based random forest after smoothing (source: uthors)"}
...
```{r, tidy = "styler", out.width = "100%", fig.align="center", fig.cap="Probability map produced for classes Forest and Clear_Cut_Bare_Soil (source: authors)."}
...
```{r, tidy = "styler", echo=TRUE, eval=TRUE, out.width = "100%", fig.align="center", fig.cap="Variance map for classes Forest and Clear_Cut_Bare_Soil (source: authors)."}
# calculate variance
...
```{r, tidy = "styler", echo=TRUE, eval=TRUE, out.width = "100%", fig.align="center", fig.cap="Variance map for clases Clear_Cut_Vegetation and Clear_Cut_Burned_Area (source: authors)."}
