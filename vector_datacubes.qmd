...
where $g_i$ denotes the spatial geometry, $t_j$ are temporal instances, and $a_{i_j}$ the vector of thematic attributes associated with that geometry for each time.
