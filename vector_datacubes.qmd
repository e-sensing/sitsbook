...
where $g_i$ denotes the spatial geometry, $t_j$ denotes a temporal instance, and $a_{ij}$ is the vector of thematic attributes associated with that geometry at each time.
