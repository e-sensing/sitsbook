...
5. Smoothing: Smoothing vector cubes use a different definition of neighborhood than  [raster-based probability smoothing](https://e-sensing.github.io/sitsbook/cl_smoothing.html). When dealing with pure raster, neighborhoods are defined based on rectangular windows (e.g., 9 x 9 size). When dealing with vector cube, neighborhoods are defined by the segments. In this case, all pixels inside a segment are used to define 
