...
if (!file.exists("./tempdir/R/datacubes"))
  dir.create("./tempdir/R/datacubes")
if (!file.exists("./tempdir/R/datacubes/s2_19HBA"))
  dir.create("./tempdir/R/datacubes/s2_19HBA")
if (!file.exists("./tempdir/R/datacubes/dem_19HBA"))
  dir.create("./tempdir/R/datacubes/dem_19HBA")
```
