...
<a href="https://www.kaggle.com/code/esensing/map-reclassification" target="_blank">
...
plot(rondonia_class, legend_text_size = 0.7)
```
## Python
```{python}
#| eval: false
...
plot(rondonia_def_2021, legend_text_size = 0.7)
```
## Python
```{python}
#| eval: false
...
```{r}
#| echo: false
#| label: py-fig-ml-reclass-prodesreclass
#| cache: true
#| fig-width: 7
#| fig-height: 5
#| fig-dpi: 300
