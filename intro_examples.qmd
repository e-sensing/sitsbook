...
To access the data, it is needed to clone the [`rondonia20LMR`](https://github.com/e-sensing/rondonia20LMR) repository from the e-sensing GitHub repository into a local directory. To do this, open a terminal and execute the following commands:
...
Let us access the Sentinel images available in the repository. First, it is necessary to define the provider, which in this case is the `Microsoft Planetary Computer`. Then, we specify the directory path, as shown below:
