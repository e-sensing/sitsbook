...
For the validation step, we extended the classification to the entire Cerrado biome using the reference samples provided by Simões et al. (2021) [@Simoes2021], in order to evaluate the results with real and independently collected data.
