...
```{r, tidy = "styler", out.width = "100%", out.height = "100%", fig.align="center", fig.cap="Default colors used in the sits package (Source: Authors)."}
# Display default `sits` colors
