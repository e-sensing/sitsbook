...
```{r, out.width = "70%", tidy="styler", fig.align = 'center', fig.cap="Color composite image MOIDS cube for 2013-09-14 (red = EVI, green = NDVI, blue = EVI).", strip.white = FALSE}
...
```{r, out.width = "70%", tidy="styler", fig.align = 'center', fig.cap="Joint plot of all samples in band NDVI for class Forest.", strip.white = FALSE}
...
```{r, out.width = "70%", tidy="styler", fig.align = 'center', fig.cap = "Probability map for class Forest."}
...
```{r, out.width = "70%",  tidy="styler", fig.align = 'center', fig.cap = "Smoothed probability map for class Forest."}
...
```{r, out.width = "90%", tidy="styler", fig.cap = "Classification map for Sinop", fig.align="center"}
...
```{r, tidy="styler",  out.width="60%", fig.align="center", fig.cap= "Sentinel-2 image in an area of the state of Rondonia, Brazil"}
# create a data cube covering an area in the Brazilian Amazon
...
```{r, tidy="styler", out.width="65%", fig.align="center", fig.cap= "Landsat-8 image in an area of the city of Brasilia, Brazil"}
...
```{r, tidy="styler", out.width="60%", fig.align="center", fig.cap="Sentinel-2 image in an area over South Africa"}
dea_cube <- sits_cube(
    source = "DEAFRICA",
    collection = "S2_L2A",
    bands = c("B05", "B8A", "B11"),
...
```{r, echo = FALSE, out.width="70%", fig.align="center", fig.cap="Hierarchical BDC tiling system showing overlayed on Brazilian Biomes (a), illustrating that one large tile (b) contains four medium tiles (c) and that medium tile contains four small tiles. Source: Ferreira et al.(2020). Reproduction under fair use doctrine."}
...
```{r, tidy="styler", out.width="60%", fig.align="center", fig.cap="CBERS-4 NDVI in an area over Brazil"}
...
```{r, tidy="styler", out.width="80%", fig.align="center", fig.cap="Classified data cube for year 2020/2021 in Rondonia, Brazil"}
...
```{r, tidy="styler", out.width="60%", fig.align="center", fig.cap="Sentinel-2 tile 20LLP for date 2018-07-03"}
...
```{r, tidy="styler", message=FALSE, results='hide', out.width="60%", fig.align="center", fig.cap="Regularized image for tile Sentinel-2 tile 20LLP"}
...
```{r, tidy="styler", out.width="60%", fig.align="center", fig.cap="NBR ratio for a regular data cube built using Sentinel-2 tiles and 20LKP and 20LLP"}
...
`sits_kfold_validate()` gives support the k-fold validation in `sits`. The following code gives an example on how to proceed a k-fold cross-validation in the package. It perform a five-fold validation using SVM classification model as a default classifier. We can see in the output text the corresponding confusion matrix and the accuracy statistics (overall and by class). In the examples below, we use multiprocessing to speed up the results.
