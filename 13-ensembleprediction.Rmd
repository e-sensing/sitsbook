...
```{r ensmapfirst, tidy = "styler", echo = TRUE, eval = TRUE, out.width="100%", fig.align="center", fig.cap= "Subset of Sentinel-2 tile 20LMR ((&copy;: EU Copernicus Sentinel Programme; source: Microsoft)."}
...
```{r unrforclass, tidy = "styler", warning = FALSE, out.width = "100%", fig.align="center", fig.cap= "Land classification in Rondonia using a random forest algorithm  (source: authors)."}
...
```{r untcnnmap, tidy = "styler", warning = FALSE, out.width = "100%", fig.align="center", fig.cap= "Land classification in Rondonia using tempCNN (source: authors)."}
...
```{r unltaemap, tidy = "styler", warning = FALSE, out.width = "100%", fig.align="center", fig.cap= "Land classification in Rondonia using tempCNN (source: authors)."}
...
```{r enavemap, tidy = "styler", out.width = "100%", fig.align="center", fig.cap= "Land classification in Rondonia using the average of the probabilities produced by Random Forest and SVM algorithms (source: authors)."}
