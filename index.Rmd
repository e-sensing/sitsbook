...
author: ["Rolf Simoes", "Gilberto Camara", "Felipe Souza", "Alber Sanchez", "Lorena Santos", "Pedro R. Andrade", "Charlotte Peletier",  "Alexandre Carvalho", "Karine Ferreira", "Gilberto Queiroz", "Victor Maus"]
date: "`r Sys.Date()`"
...
This book describes **sits** version 0.17.0. Download and install the package as explained in the Setup section. Start at Chapter 1 to get an overview of the package. Then feel free to browse the chapter for more information on topics you are interested in. 
